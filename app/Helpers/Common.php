...
class Common {
    ...
    public static function getModules() {
        ...
        $moduleArray['label'] = 'Owner Enquiries';
        $moduleArray['name'] = 'ownerinquiry';
        $moduleArray['ownerinquiry'][] = 'edit';
        $moduleArray['ownerinquiry'][] = 'delete';
        $moduleList[] = $moduleArray;
        
        $moduleArray['label'] = 'Search';
        $moduleArray['name'] = 'search';
        unset($moduleArray['ownerinquiry']);
        $moduleList[] = $moduleArray;

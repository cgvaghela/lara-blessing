...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Page List</h1>
        <ol class="breadcrumb">
            <li><a href="{!! URL::to('admin/pages/create') !!}"><i class="fa fa-plus-square"></i> Add Page</a></li>
        </ol>
    </section>
    <!-- Main content -->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        oTable = $('#pages_list').dataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": "{!! URL::to('admin/pages/PagesData') !!}",
            "columnDefs": [
        ...
        $("#pages_list").on('click', '.status-btn', function() {
            ...
            $.ajax({
                type: "POST",
                 url: "{!! URL::to('admin/pages/changeStatus') !!}",
                data: {
                    id: id,
                    _token:"{!! csrf_token() !!}"
                },
